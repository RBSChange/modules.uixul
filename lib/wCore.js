...
wCore.uploadFile = function(nsIFile, parameters, callbackComplete)
{
	...
	var module = ('module' in parameters) ? parameters.module : 'uixul';
	var action = ('action' in parameters) ? parameters.action : 'UploadFile';
	var requestUrl = wCore.buildeServerUrl(module, action, parameters);
