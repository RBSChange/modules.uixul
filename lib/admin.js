...
function changePassword()
{
	...
	window.open(url, 'changePsswd',
		'width=600, height=600, modal=yes, dialog=yes, titlebar=no, alwaysRaised=yes, close=yes, menubar=no, toolbar=no, location=no, resizable=yes, scrollbars=yes, status=no"'
	);
}
