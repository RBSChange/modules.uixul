			...
			<content>
				<xul:vbox flex="1">
					...
					<xul:hbox anonid="action-bar">					
						<xul:button anonid="save_properties" oncommand="saveProperties()" label="${{transui:m.uixul.bo.doceditor.button.Create,ucf,attr}}" image="{{IconsBase}}/small/save.png"/>
						<xul:button anonid="reset_properties" oncommand="resetProperties()" label="${{transui:m.uixul.bo.doceditor.button.Cancelcreate,ucf,attr}}" image="{{IconsBase}}/small/undo.png"/>
